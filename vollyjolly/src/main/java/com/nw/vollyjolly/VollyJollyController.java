 ...
 */
public class VollyJollyController extends Application {

    public static final String TAG = VollyJollyController.class .getSimpleName();
    public static final int TIME_OUT=1*60*1000;
