...
public class WeatherReportTextView extends TextView
{

    public WeatherReportTextView(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    public WeatherReportTextView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        if (!isInEditMode())
        {
    ...
    public WeatherReportTextView(Context context)
    {
        super(context);
        if (!isInEditMode())
        {
